...
If the current grid has the same value (i.e all 1's or all 0's) set isLeaf True and set val to the value
of the grid and set the four children to Null and stop.
...
the output format here. The output represents the serialized format of a Quad-Tree using level order traversal,
...
//    val n = grid.size
//
//    fun build(r: Int, c: Int, len: Int): Node {
//        val first = grid[r][c]
//        var same = true
//
//        run {
...
//        }
//
//        if (same) return Node(first == 1, true)
//
//        val half = len / 2
